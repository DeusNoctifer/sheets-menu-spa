...
export function MenuPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-3">
            {filteredProducts.map(product => (
              // Corregido: eliminada la llave extra que había aquí
              <ProductCard 
                key={product.id} 
                product={product} 
                onSelect={(p) => setSelectedProduct(p)}
                onAddToCart={(p) => console.log("Añadir directo al carrito:", p)}
              />
            ))}
          </div>
        ) : (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full md:max-w-md rounded-[2rem] overflow-hidden shadow-2xl z-10 animate-in slide-in-from-bottom-8 fade-in duration-300">
            ...
            <div className="p-6 space-y-6">
              ...
              <button onClick={() => { console.log("Añadir", specialMeal); setIsSpecialModalOpen(false); }} className="w-full bg-brand-primary text-white p-4 rounded-2xl font-black flex items-center justify-between shadow-lg shadow-orange-200 active:scale-[0.98] transition-all">
      ...
      {/* NUEVO: MODAL DE PRODUCTO NORMAL */}
      {selectedProduct && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full md:max-w-md rounded-[2rem] overflow-hidden shadow-2xl z-10 animate-in slide-in-from-bottom-8 fade-in duration-300 flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 space-y-6 overflow-y-auto">
              ...
              <button 
                onClick={() => {
                  console.log("Añadir al carrito", selectedProduct);
